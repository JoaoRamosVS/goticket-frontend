...
import { UserCircle, MapPin, Lock, ShoppingBag, ChevronRight, LogOut } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  { to: "/minha-conta/perfil", label: "Perfil", icon: UserCircle },
  { to: "/minha-conta/endereco", label: "Endereço", icon: MapPin },
  { to: "/minha-conta/seguranca", label: "Segurança", icon: Lock },
    ...
    <aside className="fixed left-0 top-0 bottom-0 z-40 w-72 p-4">
      ...
      >
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(77,184,232,0.35) 0%, transparent 70%)",
            filter: "blur(24px)",
          }}
        />
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(28,111,181,0.28) 0%, transparent 70%)",
            filter: "blur(24px)",
          }}
        />
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-bold text-[#00334d]">
                {userFullName || "Minha Conta"}
              </p>
              <p className="truncate text-[11px] text-[#5e6c87]">Cliente</p>
            </div>
            <button
              type="button"
